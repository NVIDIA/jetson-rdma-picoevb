...
#define PICOEVB_IOC_H2C2H_DMA	_IOW('P', 3, struct picoevb_rdma_h2c2h_dma)
#define PICOEVB_IOC_CARD_INFO	_IOR('P', 4, struct picoevb_rdma_card_info)
#define PICOEVB_IOC_H2C_DMA	_IOW('P', 5, struct picoevb_rdma_h2c_dma)
#define PICOEVB_IOC_C2H_DMA	_IOW('P', 6, struct picoevb_rdma_c2h_dma)
